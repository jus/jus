...
module.exports = function jus (sourceDir, targetDir) {
  ...
  const emitter = ee()
  // TODO: Expand Context argument to be an "opts" object
  const ctx = new Context('../files')
  const fileTypes = ctx.fileTypes

  function createFile(filename) {

    // TODO: Convert to a function like: 'type = getFileType(filename)'
    // ...and include it in Context options object "opts"
    ...
    // end of function: 'type = getFileType(filename)'
