...
const defautlPlugins  = require('require-dir')('./defaultPlugins')
...
module.exports = class Contextualizer {
  ...
  watcher (sourceDir, options) {
    ...
    function createFile(filename) {
      ...
      const file = ctx.newFile(selectedPlugin.filetype, filename, sourceDir, targetDir)
      // "inject" the plugin funtions like `parse()`, `render()`, ... to this file
      file.functions = selectedPlugin
      file.initialize()
